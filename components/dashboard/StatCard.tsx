  ...
  return (
    <div className="card-organic-solid p-5">
      <div className="flex items-center justify-between">
        ...
        <div className={`size-8 rounded-lg flex items-center justify-center ${toneClass}`}>
          <Icon className="size-4" />
        </div>
      </div>
      <p className="font-score text-4xl font-bold mt-3 text-tuka-navy">{value}</p>
      <p className="text-xs text-muted-foreground font-body mt-1">{hint}</p>
    </div>
  )
}
